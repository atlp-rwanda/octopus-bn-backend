{
	...
	"fromCountry should not be empty. Please use country letter representations example [KN, Rw, USA, UG, ...]": "fromCountry should not be empty. Please use country letter representations example [KN, Rw, USA, UG, ...]",
	"No trips to the past and the date format must be YYYY-MM-DD": "No trips to the past and the date format must be YYYY-MM-DD",
	"Please provide valid date as a return date and date format must be YYYY-MM-DD": "Please provide valid date as a return date and date format must be YYYY-MM-DD",
	"\"accommodation\" is not allowed": "\"accommodation\" is not allowed",
